...
def platform_type():
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [ibtn(_("Канал / чат"), "channel_group")],
            [ibtn(_("Бот"), "bot"), ],
            [ibtn(_("Назад"), "back"), ],
        ],
    )
...
def additional_communication(communication):
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [ibtn(_("Опубликовать площадку"), "finish"), ],
            # [ibtn(_("Назад"), "back"), ],
        ],
    )
...
def finish():
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [ibtn(_("Мои площадки"), "phone"),
             ibtn(_("Добавить еще площадку"), "email"), ],
            [ibtn(_("Главное меню"), "tg"), ],
            [ibtn(_("Назад"), "back"), ],
        ],
    )
